    ...
    return [
        {
            ...
            **common,
            ...
            "backing_source_blend": 0.16,
            "backing_percussive_blend": 0.18,
        },
        {
            "label": "anchor_style_pull_c_sep",
            **common,
            "t_start": 324,
            "t_start_end": 228,
            "reanchor_every": 4,
        ...
        },
        {
            ...
            **common,
            ...
            "backing_percussive_blend": 0.15,
        },
        {
            "label": "anchor_style_pull_d_sep",
            **common,
            "t_start": 336,
            "t_start_end": 236,
            "reanchor_every": 4,
        ...
        },
        {
            ...
            **common,
            ...
            "hf_start_bin": 60,
            "accomp_mix_gain": 0.99,
            "backing_source_blend": 0.14,
            "backing_percussive_blend": 0.16,
        },
        {
            "label": "anchor_style_pull_e_sep",
            **common,
            "t_start": 318,
            "t_start_end": 230,
            "reanchor_every": 5,
...
def main() -> None:
    if len(sys.argv) > 1 and sys.argv[1] == "--resume-latest":
        parent = Path.home() / "Desktop" / "dggr_hybrid_genre_separation"
        ...
        out_root = Path.home() / "Desktop" / "dggr_hybrid_genre_separation" / f"genre_sep_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
