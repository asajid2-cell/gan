...
def candidate_variants() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            "label": "graft_a",
            "accomp_mix_gain": 1.00,
            "backing_source_blend": 0.05,
            "backing_percussive_blend": 0.06,
            "backing_post_mode": "genre_graft",
            "backing_post_strength": 0.26,
            "backing_dewarble_strength": 0.26,
            **common,
        },
        {
            "label": "graft_b",
            ...
            "backing_post_mode": "genre_graft",
            "backing_post_strength": 0.38,
            "backing_dewarble_strength": 0.30,
            **common,
        },
        {
            "label": "graft_c",
            "accomp_mix_gain": 1.02,
            "backing_source_blend": 0.01,
            "backing_percussive_blend": 0.02,
            "backing_post_mode": "genre_graft",
        ...
        },
        {
            ...
            "backing_percussive_blend": 0.00,
            "backing_post_mode": "genre_graft",
            "backing_post_strength": 0.74,
            "backing_dewarble_strength": 0.20,
            **common,
        },
        {
            "label": "graft_f",
            "accomp_mix_gain": 1.06,
            "backing_source_blend": 0.00,
            "backing_percussive_blend": 0.00,
            "backing_post_mode": "genre_graft",
            "backing_post_strength": 0.86,
...
def main() -> None:
    out_root = Path.home() / "Desktop" / "dggr_hybrid_backing_graft_opt" / f"graftopt_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
    out_root.mkdir(parents=True, exist_ok=True)
    oto = _load_tradeoff_module()
    mert = oto.FrozenMERT(model_id="m-a-p/MERT-v1-95M", chunk_seconds=5.0, device="cpu", layer=-1)
