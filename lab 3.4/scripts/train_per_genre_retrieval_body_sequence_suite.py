...
TARGET_CONFIGS = {
    "baroque_classical": {"epochs": 4, "max_batches": 480},
    "hiphop_xtc": {"epochs": 4, "max_batches": 480},
    "lofi_hh_lfbb": {"epochs": 4, "max_batches": 480},
    "cc0_other": {"epochs": 4, "max_batches": 400},
}
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Train per-genre scratch retrieval body-style sequence models and aggregate their production pack.")
    ap.add_argument("--out-root", type=Path, default=REPO_ROOT / "Desktop Outputs" / "dggr_per_genre_retrieval_body_style_sequence_suite")
    ...
    script = REPO_ROOT / "lab 3.4" / "scripts" / "train_scratch_retrieval_body_style_sequence.py"
    ...
    report_lines = [
        "# Per-Genre Retrieval Body-Style Sequence Suite",
        "",
        "- Each target genre was trained as its own scratch retrieval-conditioned accompaniment generator with explicit body and groove retention losses plus two-step sequence conditioning over previous windows.",
