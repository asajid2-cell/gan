...
TARGET_CONFIGS = {
    "baroque_classical": {"epochs": 4, "max_batches": 240},
    "hiphop_xtc": {"epochs": 4, "max_batches": 240},
    "lofi_hh_lfbb": {"epochs": 4, "max_batches": 240},
    "cc0_other": {"epochs": 4, "max_batches": 200},
}
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Train per-genre scratch retrieval body-style block-sequence models and aggregate their production pack.")
    ap.add_argument("--out-root", type=Path, default=REPO_ROOT / "Desktop Outputs" / "dggr_per_genre_retrieval_body_style_block_suite")
    ...
    script = REPO_ROOT / "lab 3.4" / "scripts" / "train_scratch_retrieval_body_style_block_sequence.py"
    ...
    report_lines = [
        ...
        "",
        "- Each target genre was trained as its own scratch retrieval-conditioned accompaniment generator with explicit body and groove retention losses over longer block windows with hidden warm-up overlap.",
