...
TARGET_CONFIGS = {
    "baroque_classical": {"epochs": 1, "max_batches": 140},
    "hiphop_xtc": {"epochs": 1, "max_batches": 160},
    "lofi_hh_lfbb": {"epochs": 1, "max_batches": 140},
    "cc0_other": {"epochs": 1, "max_batches": 120},
}
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Train per-genre sourcehint retrieval models and aggregate their production pack.")
    ap.add_argument("--out-root", type=Path, default=Path.home() / "Desktop" / "dggr_per_genre_sourcehint_suite")
    ...
    script = REPO_ROOT / "lab 3.4" / "scripts" / "train_scratch_sourcehint_retrieval.py"
    ...
    report_lines = [
        "# Per-Genre SourceHint Retrieval Suite",
        "",
        "- Each target genre was trained as its own scratch sourcehint+retrieval accompaniment generator.",
